...
public class AddressBook1 {
	...
	public static void main(String[] args) throws JsonGenerationException, JsonMappingException, IOException {
		...
		String fileOut = "/home/admin/seleninum/eclipse-workspace/JavaPrograms/src/com/bridgelabz/jsonfiles/akshay.json";
		...
		case 1:
			...
			if (!isFound) {
				...
				while (!exit) {
					...
					firstname = Utility.scanString();
					person.setFirstname(firstname);
					System.out.println("Enter the last name");
					lastname = Utility.scanString();
					person.setLastname(lastname);
					System.out.println("Enter the address");
					address = Utility.scanString();
					person.setAddress(address);
					System.out.println("Enter the city");
					city = Utility.scanString();
					person.setCity(city);
					person.setState(state1);
		...
		case 2:// opening addressbook
			...
			int addressbookPosition = Utility.scanInt() - 1;
			isFound = false;
						...
						mobile=Utility.scanString();
				 		...
				 		else
				 		{
							...
							while(!exit)
							{
								...
								int optionSelect=Utility.scanInt();
								switch(optionSelect)
								{
